"""
GranjaAgent v11 — rota open-loop de pecuaria (8 COW / 4 SHEEP / NE+NW+SW).
...
Diferenca vs v10 (C95): rota 8C/4S (vs 9C/4S) + weed repair. Market lead removido
em 17/08 por ablation (0 diff no 1.32.7 em todos os testes).

Validado localmente (engine 1.32.7):
  - Bench local (12 seeds vs passivos): ~152-165k (12/12 vitórias).
  - Pool contrafactual (11 replays reais x 2 seats = 22 jogos): 22/22, margem media +73.838.
