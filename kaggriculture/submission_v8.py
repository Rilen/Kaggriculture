"""
Kaggriculture Autonomous AI Agent — submission_v8.py
Experimento 2 (acumulo): v7 (MELAO CEDO + VOLUME) + MAIS MAOS.

Base: submission_v7.py. Mudancas sobre o v7:
4. HIRE: teto de maos elevado de 4+min(4,day//5) [ate 8] para 6+min(6,day//4)
   [ate 12], para regar/colher 100% das plantas com a area e o volume maiores.

Herda do v7: MELON_TARGET 24, _choose_plant prioriza MELON, sementes de melao 8.
